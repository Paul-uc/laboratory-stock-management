<nav x-data="{ open: false }" class="border-b border-gray-100" style="background-image: url('/images/navigation.png'); background-size: cover; background-position: center;">

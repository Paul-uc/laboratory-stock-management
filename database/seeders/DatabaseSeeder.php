...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        returnStock::create(['loan_stock_id' => 1 ,'approval_id' => 1 ,'stock_id' => 1,'user_id'=> 2,'userId'=> 2,'status' => 1, 'name'=> 'Moderator', 'position'=> 'dean', 'remark'=> 'testing' ]);
        returnStock::create(['loan_stock_id' => 2 ,'approval_id' => 2 ,'stock_id' => 2, 'user_id'=> 2, 'userId'=> 2,'status' => 1, 'name'=> 'Moderator', 'position'=> 'dean', 'remark'=> 'testing'  ]);
